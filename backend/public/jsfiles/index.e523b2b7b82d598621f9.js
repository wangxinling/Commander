import * as __WEBPACK_EXTERNAL_MODULE_https_esm_run_mlc_ai_web_llm_c4b7b6a0__ from "https://esm.run/@mlc-ai/web-llm";
...
/*!**************************************************!*\
  !*** external "https://esm.run/@mlc-ai/web-llm" ***!
  \**************************************************/
/***/ ((module) => {

module.exports = __WEBPACK_EXTERNAL_MODULE_https_esm_run_mlc_ai_web_llm_c4b7b6a0__;
...
/* harmony import */ var _message_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./message.js */ "./src/models/message.js");



const HistoryList = backbone__WEBPACK_IMPORTED_MODULE_0__.Collection.extend({
    model:_message_js__WEBPACK_IMPORTED_MODULE_1__["default"],
...
const HistoryView = backbone__WEBPACK_IMPORTED_MODULE_0__.View.extend({
    //find history div
    el: jquery__WEBPACK_IMPORTED_MODULE_2__('#history'),
    ...
    addOne: function (message) {
        var messageView = new _MessageView_js__WEBPACK_IMPORTED_MODULE_1__["default"]({ model: message });
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (HistoryView);

/***/ }),

/***/ "./src/views/MessageView.js":
/*!**********************************!*\
  !*** ./src/views/MessageView.js ***!
  \**********************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _models_message_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../models/message.js */ "./src/models/message.js");
...
/*!**********************!*\
  ...
  \**********************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var https_esm_run_mlc_ai_web_llm__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! https://esm.run/@mlc-ai/web-llm */ "https://esm.run/@mlc-ai/web-llm");
/* harmony import */ var _views_HistoryView_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./views/HistoryView.js */ "./src/views/HistoryView.js");
/* harmony import */ var _models_historyList_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./models/historyList.js */ "./src/models/historyList.js");
/* harmony import */ var _models_message_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./models/message.js */ "./src/models/message.js");
...
const availableModels = https_esm_run_mlc_ai_web_llm__WEBPACK_IMPORTED_MODULE_0__.prebuiltAppConfig.model_list.map(
  (m) => m.model_id,
);
...
const engine = new https_esm_run_mlc_ai_web_llm__WEBPACK_IMPORTED_MODULE_0__.MLCEngine();
...
function onMessageSend() {
  ...
  const userMessage = new _models_message_js__WEBPACK_IMPORTED_MODULE_3__["default"]();
  ...
  const onFinishGenerating = (finalMessage, usage) => {
    ...
    const historyMessage = new _models_message_js__WEBPACK_IMPORTED_MODULE_3__["default"]();
...
var historyData = new _models_historyList_js__WEBPACK_IMPORTED_MODULE_2__["default"]();

var history = new _views_HistoryView_js__WEBPACK_IMPORTED_MODULE_1__["default"]({model:historyData});
})();
